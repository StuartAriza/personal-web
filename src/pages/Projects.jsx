...
const projects = [
  ...
  desc: 'Full-stack transaction monitoring system that simulates real-time fraud detection using modular rule-based risk scoring. Includes API-driven transaction ingestion, composite fraud scoring, and a monitoring dashboard for reviewing flagged activity.',
  result: 'End-to-end fraud scoring pipeline with real-time monitoring and containerized deployment',
  type: 'backend',
