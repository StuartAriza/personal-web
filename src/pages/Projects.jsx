...
const projects = [
  ...
  {
    id: 3,
    title: 'PayFlow — Payments Monitoring UI',
    category: 'Web Application',
    focus: 'Payments',
    year: '2023',
    tags: ['React', 'TypeScript', 'Node.js', 'REST APIs'],
    desc: 'Payments monitoring interface with transaction feeds, threshold-based alerts, and exportable audit logs. Built with role-based views and auditability in mind.',
    result: 'End-to-end monitoring flow with alerting + exportable logs',
    type: 'fintech',
    github: 'https://github.com',
